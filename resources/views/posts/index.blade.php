            ...
            <a class="blockLink" href="/posts/{{$post->id}}">
              <div class="row">
                <div class="col-md-4 col-sm-4">
                  ...
                  <img class="allGrowsImg" src="https://s3.amazonaws.com/final-project-growshow/uploads/{{$post->cover_image}}">
                ...
                <div class="col-md-3 col-sm-3 image-cropper">
                  <img class="my-picture" src="https://s3.amazonaws.com/final-project-growshow/uploads/{{$post->user->avatar}}">
